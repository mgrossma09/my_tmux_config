...
alias vif="vim <(fzf --tmux=center)"

# Adding nix-profile installed binaries to the system path
export PATH=$HOME/.nix-profile/bin:$PATH
# On load allow direnv to manage the per-directory nix packages
eval "$(direnv hook $(basename $(echo $SHELL)))"
